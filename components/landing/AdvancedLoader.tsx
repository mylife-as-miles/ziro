      ...
      <div className="relative z-10 text-center">
        ...
        <div className="mb-8 relative">
          <div className={`transition-all duration-1000 ${stage >= 1 ? 'scale-100 opacity-100' : 'scale-50 opacity-0'}`}>
            ...
            <div className="h-1 w-32 mx-auto bg-gradient-to-r from-transparent via-yellow-400 to-transparent opacity-60" />
          </div>
        </div>

        {/* Loading text */}
        <div className={`mb-8 transition-all duration-700 ${stage >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
        ...
        <div className={`transition-all duration-500 ${stage >= 3 ? 'opacity-100' : 'opacity-0'}`}>
          <div className="flex items-center justify-center space-x-2 text-yellow-400">
            ...
            <span className="text-sm font-medium">Ready to discover hidden APIs</span>
          </div>
        </div>
      </div>
